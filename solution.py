...
class Paddle:
    ...
    def __init__(self,x,y,width,height):
        ...
        self.height = height
    def draw(self, wind):
        pygame.draw.rect(wind,self.COLOR,(self.x,self.y,self.width,self.height))
...
def handle_coll(ball, left_paddle, right_paddle):
...
def main():
    ...
    while run:
        ...
        ball.move()
        handle_coll(ball, left_paddle, right_paddle)
